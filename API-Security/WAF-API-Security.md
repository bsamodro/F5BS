...
Click "Local Traffic" -> Virtual Servers -> Virtual Server List -> Choose sentence-vs -> Click Security -> Policies ->  Select Enabled in "Application Security Policy" -> Choose Policy "sentence-api-security-waf" -> Enable log profile and add Log all request -> Click Update
